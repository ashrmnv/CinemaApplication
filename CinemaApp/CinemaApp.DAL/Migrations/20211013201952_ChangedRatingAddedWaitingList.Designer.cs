...
namespace CinemaApp.DAL.Migrations
{
    ...
    [Migration("20211013201952_ChangedRatingAddedWaitingList")]
    partial class ChangedRatingAddedWaitingList
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MovieUser", b =>
                {
                    b.Property<int>("MovieWaitingListId")
                        .HasColumnType("int");

                    b.Property<int>("UserWaitingListId")
                        .HasColumnType("int");

                    b.HasKey("MovieWaitingListId", "UserWaitingListId");
            ...
            modelBuilder.Entity("MovieUser", b =>
                {
                    b.HasOne("CinemaApp.Domain.Movie", null)
                        .WithMany()
                        .HasForeignKey("MovieWaitingListId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
